...
namespace AracSatis.Models.Entity
{
    ...
    public partial class AracSatisEntities : DbContext
    {
        public AracSatisEntities()
            : base("name=AracSatisEntities")
        {
        }
        ...
        public virtual DbSet<Tbl_Blockchain> Tbl_Blockchain { get; set; }
